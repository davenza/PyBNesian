...
namespace dataset {
    ...
    public:
        CrossValidationProperties(const DataFrame& df, int k, unsigned int seed, bool include_null) : k(k),
                                                                                             m_seed(seed),
                                                                                             indices(), 
                                                                                             limits(), 
    ...
    public:
        ...
        CrossValidation(const DataFrame df, int k, unsigned int seed, bool include_null = false) : 
                                                    m_df(df),
