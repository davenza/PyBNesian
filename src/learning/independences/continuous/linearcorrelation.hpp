...
namespace learning::independences::continuous {
    ...
    // class LinearCorrelation : public independence_traits<DataFrameType>::independence_base {
    // public:
    //     LinearCorrelation(const DataFrameType df) : m_df(df),
    //                                                 m_cached_cov(false),
    //                                                 m_indices(),
    //                                                 m_cov() {
