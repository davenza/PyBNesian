...
namespace util {
    ...
    T uniroot(F function,	/* Function under investigation	*/
        ...
        while(maxit--) {	/* Main iteration loop	*/
            ...
            if(fabs(prev_step) >= tol_act	/* If prev_step was large enough*/ && fabs(fa) > fabs(fb) ) {	/* and was in true direction,
                ...
                if(p < (0.75*cb*q-fabs(tol_act*q)/2) /* If b+p/q falls in [b,c]*/ && p < fabs(prev_step*q/2))	/* and isn't too large	*/
            ...
            b += new_step;	fb = function(b);	/* Do step to a new approxim. */
