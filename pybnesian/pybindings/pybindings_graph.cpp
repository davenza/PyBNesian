...
void add_graphbase_methods(PyClass& c) {
    c.def("num_nodes", &CppClass::num_nodes)
        ...
        .def("remove_node", [](CppClass& self, int index) { self.remove_node(index); })
        .def("remove_node", [](CppClass& self, const std::string& name) { self.remove_node(name); })
...
void add_conditionalgraphbase_methods(PyClass& c) {
    c.def("num_nodes", &CppClass::num_nodes)
        ...
        .def("remove_node", [](CppClass& self, int index) { self.remove_node(index); })
        .def("remove_node", [](CppClass& self, const std::string& name) { self.remove_node(name); })
        .def("remove_interface_node", [](CppClass& self, int index) { self.remove_interface_node(index); })
        .def("remove_interface_node", [](CppClass& self, const std::string& name) { self.remove_interface_node(name); })
        .def("name", &CppClass::name)
        .def("collapsed_name", &CppClass::collapsed_name)
        ...
        .def("is_interface", [](CppClass& self, int index) { return self.is_interface(index); })
        .def("is_interface", [](CppClass& self, const std::string& name) { return self.is_interface(name); })
        .def("set_interface", [](CppClass& self, int index) { self.is_interface(index); })
        .def("set_interface", [](CppClass& self, const std::string& name) { self.set_interface(name); })
        .def("set_node", [](CppClass& self, int index) { self.set_node(index); })
        .def("set_node", [](CppClass& self, const std::string& name) { self.set_node(name); })
        .def("is_valid", &CppClass::is_valid);
}

template <typename CppClass, typename PyClass>
void add_arcgraph_methods(PyClass& c) {
    c.def("num_arcs", &CppClass::num_arcs)
        .def("num_parents", [](CppClass& self, int index) { return self.num_parents(index); })
        .def("num_parents", [](CppClass& self, const std::string& name) { return self.num_parents(name); })
        .def("num_children", [](CppClass& self, int index) { return self.num_parents(index); })
        .def("num_children", [](CppClass& self, const std::string& name) { return self.num_parents(name); })
        .def("arcs", &CppClass::arcs)
        .def("parents", [](CppClass& self, int index) { return self.parents(index); })
        .def("parents", [](CppClass& self, const std::string& name) { return self.parents(name); })
        .def("children", [](CppClass& self, int index) { return self.children(index); })
        .def("children", [](CppClass& self, const std::string& name) { return self.children(name); })
        .def("add_arc", [](CppClass& self, int source, int target) { self.add_arc(source, target); })
        .def("add_arc",
             [](CppClass& self, const std::string& source, const std::string& target) { self.add_arc(source, target); })
        .def("has_arc", [](CppClass& self, int source, int target) { return self.has_arc(source, target); })
        .def("has_arc",
             [](CppClass& self, const std::string& source, const std::string& target) {
                 return self.has_arc(source, target);
             })
        .def("remove_arc", [](CppClass& self, int source, int target) { self.remove_arc(source, target); })
        .def("remove_arc",
             [](CppClass& self, const std::string& source, const std::string& target) {
                 self.remove_arc(source, target);
             })
        .def("flip_arc", [](CppClass& self, int source, int target) { self.flip_arc(source, target); })
        .def(
            "flip_arc",
            [](CppClass& self, const std::string& source, const std::string& target) { self.flip_arc(source, target); })
        .def("roots",
             [](CppClass& self) {
    ...
    if constexpr (graph::is_conditional_graph_v<CppClass>) {
        c.def("interface_arcs", &CppClass::template interface_arcs<>);
    }
}

template <typename CppClass, typename PyClass>
void add_edgegraph_methods(PyClass& c) {
    c.def("num_edges", &CppClass::num_edges)
        .def("num_neighbors", [](CppClass& self, int index) { return self.num_neighbors(index); })
        .def("num_neighbors", [](CppClass& self, const std::string& name) { return self.num_neighbors(name); })
        .def("edges", &CppClass::edges)
        .def("neighbors", [](CppClass& self, int index) { return self.neighbors(index); })
        .def("neighbors", [](CppClass& self, const std::string& name) { return self.neighbors(name); })
        .def("add_edge", [](CppClass& self, int source, int target) { self.add_edge(source, target); })
        .def(
            "add_edge",
            [](CppClass& self, const std::string& source, const std::string& target) { self.add_edge(source, target); })
        .def("has_edge", [](CppClass& self, int source, int target) { return self.has_edge(source, target); })
        .def("has_edge",
             [](CppClass& self, const std::string& source, const std::string& target) {
                 return self.has_edge(source, target);
             })
        .def("remove_edge", [](CppClass& self, int source, int target) { self.remove_edge(source, target); })
        .def("remove_edge", [](CppClass& self, const std::string& source, const std::string& target) {
            self.remove_edge(source, target);
        });

    if constexpr (graph::is_conditional_graph_v<CppClass>) {
        c.def("interface_edges", &CppClass::template interface_edges<>);
    }
}

template <typename CppClass, typename PyClass>
void add_pdag_methods(PyClass& c) {
    c.def("direct", [](CppClass& self, int source, int target) { self.direct(source, target); })
        .def("direct",
             [](CppClass& self, const std::string& source, const std::string& target) { self.direct(source, target); })
        .def("undirect", [](CppClass& self, int source, int target) { self.undirect(source, target); })
        .def(
            "undirect",
            [](CppClass& self, const std::string& source, const std::string& target) { self.undirect(source, target); })
        .def("has_connection",
        ...
        .def("to_dag", [](const CppClass& self) { return self.to_dag(); })
        .def("to_approximate_dag", [](const CppClass& self) { return self.to_approximate_dag(); });
}

template <typename CppClass, typename PyClass>
void add_directed_methods(PyClass& c) {
    c.def("has_path", [](CppClass& self, int source, int target) {
...
void add_to_conditional_methods(PyClass& c) {
    c.def("conditional_graph", py::overload_cast<>(&CppClass::conditional_graph, py::const_))
...
void pybindings_normal_graph(py::module& graph) {
    ...
    dag.def(py::init<>())
        ...
        .def("can_add_arc", [](Dag& self, int source, int target) { return self.can_add_arc(source, target); })
        .def("can_add_arc",
             [](Dag& self, const std::string& source, const std::string& target) {
                 return self.can_add_arc(source, target);
             })
        .def("can_flip_arc", [](Dag& self, int source, int target) { return self.can_flip_arc(source, target); })
        .def("can_flip_arc",
             [](Dag& self, const std::string& source, const std::string& target) {
                 return self.can_flip_arc(source, target);
             })
        .def("add_arc", [](Dag& self, int source, int target) { self.add_arc(source, target); })
        .def("add_arc",
             [](Dag& self, const std::string& source, const std::string& target) { self.add_arc(source, target); })
        .def("flip_arc", [](Dag& self, int source, int target) { self.flip_arc(source, target); })
        .def("flip_arc",
...
void pybindings_conditional_graph(py::module& graph) {
    ...
    cdag.def(py::init<>())
        ...
        .def("add_arc", [](ConditionalDag& self, int source, int target) { self.add_arc(source, target); })
        .def("add_arc",
             [](ConditionalDag& self, const std::string& source, const std::string& target) {
                 self.add_arc(source, target);
             })
        .def("flip_arc", [](ConditionalDag& self, int source, int target) { self.flip_arc(source, target); })
        .def("flip_arc",
             [](ConditionalDag& self, const std::string& source, const std::string& target) {
