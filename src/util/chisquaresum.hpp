...
namespace detail {
    ...
    template<typename VectorType>
    Matrix<typename VectorType::Scalar, Dynamic, 1> mu_roots(VectorType& moments, typename VectorType::Scalar lambda_tilde, int p) {
        using Scalar = typename VectorType::Scalar;
    ...
    template<typename VectorType> 
    VectorType mixture_proportions(VectorType& mu,
                                VectorType& moments,
