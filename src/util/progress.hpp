...
namespace util {
    ...
    public:
        ProgressBar() : m_bar(indicators::option::BarWidth{40},
                              indicators::option::Start{"["},
                              indicators::option::End{"]"},
                              indicators::option::ShowElapsedTime{true},
                              indicators::option::ForegroundColor{indicators::Color::white}) {}
        
        ProgressBar(int max_progress) : m_bar(indicators::option::BarWidth{40},
                                              indicators::option::Start{"["},
                                              indicators::option::End{"]"},
                                              indicators::option::ShowElapsedTime{true},
                                              indicators::option::ForegroundColor{indicators::Color::white},
        ...
        void add_progress(int progress) override {
            m_bar.set_progress(m_bar.current() + progress);
        }
        ...
        void clean_terminal() override {
            std::cout << std::string(indicators::terminal_width(), ' ') << "\r";
        }
