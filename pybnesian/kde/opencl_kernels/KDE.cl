...
__kernel void add_logl_values_1d_mat_double(__constant double *train_vector,
                                           __private uint train_rows,
                                           __constant double *test_vector,
                                           __private uint test_offset,
                                           __constant double *standard_deviation,
...
__kernel void conditional_means_1d_double(__constant double *train_mat,
...
__kernel void sum_ucv_1d_double(__constant double *data,
                              __private uint index_offset,
                              __constant double *h,
                              __private double lognorm_2h,
                              __private double lognorm_h,
                              __global double *sum2h,
                              __global double *sumh) {
    unsigned int i = get_global_id(0) + index_offset;
    double ii = get_global_id(0) + 1;
...
// https://stackoverflow.com/questions/40950460/how-to-convert-triangular-matrix-indexes-in-to-row-column-coordinates
__kernel void triangular_substract_mat_double(__constant double *data,
...
__kernel void sum_ucv_mat_double(__constant double *square_mat,
                               __private uint square_cols,
                               __private double lognorm_2H,
                               __private double lognorm_H,
                               __global double *sum2H,
...
// https://stackoverflow.com/questions/40950460/how-to-convert-triangular-matrix-indexes-in-to-row-column-coordinates
__kernel void ucv_diag_double(__constant double *data,
                                __private uint index_offset,
                                __constant double *h,
                                __global double *tmph) {
    unsigned int i = get_global_id(0) + index_offset;
    double ii = get_global_id(0) + 1;
...
// https://stackoverflow.com/questions/40950460/how-to-convert-triangular-matrix-indexes-in-to-row-column-coordinates
__kernel void sum_ucv_diag_double(__constant double *data,
                                __private uint data_physical_rows,
                                __private uint index_offset,
                                __constant double *h,
...
// https://stackoverflow.com/questions/40950460/how-to-convert-triangular-matrix-indexes-in-to-row-column-coordinates
__kernel void copy_ucv_diag_double(__constant double *tmph,
                                 __private double lognorm_2H,
                                 __private double lognorm_H,
                                 __global double *sum2H,
                                 __global double *sumH) {
...
__kernel void add_logl_values_1d_mat_float(__constant float *train_vector,
                                           __private uint train_rows,
                                           __constant float *test_vector,
                                           __private uint test_offset,
                                           __constant float *standard_deviation,
...
__kernel void conditional_means_1d_float(__constant float *train_mat,
                                           __private uint train_physical_rows,
                                           __constant float *test_vector,
                                           __private uint test_physical_rows,
                                           __private uint test_offset,
...
// https://stackoverflow.com/questions/40950460/how-to-convert-triangular-matrix-indexes-in-to-row-column-coordinates
__kernel void sum_ucv_1d_float(__constant float *data,
                              __private uint index_offset,
                              __constant float *h,
                              __private float lognorm_2h,
                              __private float lognorm_h,
                              __global float *sum2h,
                              __global float *sumh) {
    unsigned int i = get_global_id(0) + index_offset;
    double ii = get_global_id(0) + 1;
...
// https://stackoverflow.com/questions/40950460/how-to-convert-triangular-matrix-indexes-in-to-row-column-coordinates
__kernel void triangular_substract_mat_float(__constant float *data,
                                            __private uint data_physical_rows,
                                            __private uint data_cols,
                                            __private uint index_offset,
                                            __private uint res_num_rows,
...
__kernel void sum_ucv_mat_float(__constant float *square_mat,
                               __private uint square_cols,
                               __private float lognorm_2H,
                               __private float lognorm_H,
                               __global float *sum2H,
...
// https://stackoverflow.com/questions/40950460/how-to-convert-triangular-matrix-indexes-in-to-row-column-coordinates
__kernel void ucv_diag_float(__constant float *data,
                                __private uint index_offset,
                                __constant float *h,
                                __global float *tmph) {
    unsigned int i = get_global_id(0) + index_offset;
...
// https://stackoverflow.com/questions/40950460/how-to-convert-triangular-matrix-indexes-in-to-row-column-coordinates
__kernel void sum_ucv_diag_float(__constant float *data,
                                __private uint data_physical_rows,
                                __private uint index_offset,
                                __constant float *h,
                                __private uint h_index,
...
// https://stackoverflow.com/questions/40950460/how-to-convert-triangular-matrix-indexes-in-to-row-column-coordinates
__kernel void copy_ucv_diag_float(__constant float *tmph,
                                 __private float lognorm_2H,
                                 __private float lognorm_H,
                                 __global float *sum2H,
                                 __global float *sumH) {
